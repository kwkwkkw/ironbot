...
async def _(dyno):        
        try:
  	       ...
  	       return await dyno.reply(" Please make sure your Heroku API Key, Your App name are configured correctly in the heroku Please Join @Ironbots For Any Issue")
        await dyno.edit("Getting Logs....")
        with open('Ironbots logs.txt', 'w') as log:
        ...
        await dyno.delete()
        return os.remove('Ironbots logs.txt')
